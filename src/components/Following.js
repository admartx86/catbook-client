    ...
    <div>
      <header>
        ...
        <div className="p-4 sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl break-all">
          {username == profileUsername ? 'you are' : `${profileUsername} is`}{' '}
      ...
      <main>
        {loading ? (
          ...
          <p>{error.message}</p>
        ) : Array.isArray(rearrangedProfileIsFollowing) &&
          rearrangedProfileIsFollowing.length > 0 ? (
          <div>
                  ...
                  following.includes(userBeingFollowedByProfileUsername._id) ? (
                    <div>
                      <button
                        ...
                        onClick={() =>
                          handleUnfollow(username, userBeingFollowedByProfileUsername.username)
                        }
                      >
                        Following
                      </button>
                    ...
                    <div>
                      <button
                        ...
                        sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl"
                        onClick={() =>
                          handleFollow(username, userBeingFollowedByProfileUsername.username)
                        }
                      >
                        Follow
                      </button>
